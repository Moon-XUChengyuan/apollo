...
void NDTLocalizationComponent::LidarCallback(
  ...
  AINFO<<"CPU core:  "<< sched_getcpu()<<" Module "<< MODULE_NAME<<" LidarCallback start, itr: "<< ++calledTimes_LidarCallback;
  ...
  AINFO<<"CPU core:  "<< sched_getcpu()<<" Module "<< MODULE_NAME<<" LidarCallback end, itr: "<< calledTimes_LidarCallback;
}

void NDTLocalizationComponent::OdometryStatusCallback(
    const std::shared_ptr<drivers::gnss::InsStat>& status_msg) {
  AINFO<<"CPU core:  "<< sched_getcpu()<<" Module "<< MODULE_NAME<<" OdometryStatusCallback start, itr: "<< ++calledTimes_OdometryStatusCallback;
  localization_->OdometryStatusCallback(status_msg);
  AINFO<<"CPU core:  "<< sched_getcpu()<<" Module "<< MODULE_NAME<<" OdometryStatusCallback end, itr: "<< calledTimes_OdometryStatusCallback;
}
